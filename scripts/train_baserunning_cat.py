"""Train the Phase 6 baserunning multiclass model and pin the run id.

Run via:
    uv run --group migration-ml python scripts/train_baserunning_cat.py \
...
from python_models.ml.features import BASERUNNING_CAT  # noqa: E402
