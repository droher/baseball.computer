"""Train the Phase 6 has-batting binary model and pin the run id.

Run via:
    uv run --group migration-ml python scripts/train_has_batting_bin.py \
...
from python_models.ml.features import HAS_BATTING_BIN  # noqa: E402
