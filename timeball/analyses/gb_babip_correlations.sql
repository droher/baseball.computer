WITH t AS (SELECT
    ...
    SUM(trajectory_broad_type_air_ball)/SUM(trajectory_known) AS air_ball_rate,
    SUM(trajectory_line_drive)/SUM(trajectory_broad_type_air_ball) AS ld_rate,
    SUM(trajectory_pop_fly)/SUM(trajectory_broad_type_air_ball) AS pu_rate,
    SUM(home_runs)/SUM(trajectory_broad_type_air_ball) AS hr_rate,
    ...
    SUM(trajectory_broad_type_air_ball * batted_balls_pulled)/SUM(trajectory_broad_type_air_ball) AS pulled_air,
    SUM(trajectory_broad_type_air_ball * batted_balls_opposite_field)/SUM(trajectory_broad_type_air_ball) AS oppo_air,
    SUM(trajectory_broad_type_air_ball * batted_angle_middle)/SUM(trajectory_broad_type_air_ball) AS middle_air,
