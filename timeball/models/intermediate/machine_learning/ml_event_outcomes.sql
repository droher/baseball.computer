...
joined AS (
    SELECT
        ...
        COALESCE(pa_map.contact != 'Unknown', FALSE)::UTINYINT AS has_known_contact,
...
final AS (
    SELECT * REPLACE (
        ...
        contact_sample_weight / AVG(contact_sample_weight) OVER ()::FLOAT AS contact_sample_weight,
