...
WITH final AS (
    SELECT
        ...
        CASE WHEN batted_to_fielder BETWEEN 1 AND 2 THEN 1 ELSE 0 END AS fielded_in_battery,
        CASE WHEN batted_to_fielder BETWEEN 3 AND 6 THEN 1 ELSE 0 END AS fielded_in_infield,
        CASE WHEN batted_to_fielder BETWEEN 7 AND 9 THEN 1 ELSE 0 END AS fielded_in_outfield,
        CASE WHEN batted_to_fielder = 0 THEN 1 ELSE 0 END AS fielded_in_unknown,
