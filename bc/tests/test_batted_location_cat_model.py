"""Unit tests for the batted-location multiclass model factory + Scorer contract."""
...
from python_models.ml.model_batted_location_cat import build_model as build_shim_model
...
def test_build_model_softmax_output_shape() -> None:
    ...
    for n in (5, 9, 13):
        ...
        assert model.name == BATTED_LOCATION_CAT.name
...
def test_scorer_emits_multiclass_schema() -> None:
    labels = ("Deep-Left", "Deep-Right", "Shallow-Left", "Shallow-Right")
