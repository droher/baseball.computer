"""Unit tests for the batted-trajectory multiclass model factory + Scorer contract."""
...
from python_models.ml.model_batted_trajectory_cat import build_model as build_shim_model
...
def test_build_model_softmax_output_shape() -> None:
    ...
    for n in (3, 5, 7):
        ...
        assert model.name == BATTED_TRAJECTORY_CAT.name
...
def test_scorer_emits_multiclass_schema() -> None:
    labels = ("FlyBall", "GroundBall", "LineDrive", "Popup")
