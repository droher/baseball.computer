"""Unit tests for the has-batting binary model factory + Scorer contract."""
...
from python_models.ml.model_has_batting_bin import build_model as build_shim_model
...
def test_binary_build_model_emits_single_sigmoid_output() -> None:
    ...
    assert model.name == HAS_BATTING_BIN.name
