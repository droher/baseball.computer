MODEL (
  name main_models.metrics_team_season_fielding,
  kind FULL,
  description 'Aggregate fielding statistics and averages for each team-season. Regular season only.',
  ...
  physical_properties (
    download_parquet = 'https://data.baseball.computer/dbt/main_models_metrics_team_season_fielding.parquet'
  ),
);
