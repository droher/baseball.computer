MODEL (
  name main_models.scorekeeper_tendencies_contact,
  kind VIEW
);
...
WITH final AS (
    SELECT
        ...
        hits_trajectory_known / COUNT_IF(hits > 0) AS trajectory_known_hit_rate,
    ...
    LEFT JOIN main_models.stg_events AS e USING (game_id, event_key)
