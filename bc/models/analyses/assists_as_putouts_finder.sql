MODEL (
  name main_models.assists_as_putouts_finder,
  kind VIEW
);
...
e AS (
    ...
    INNER JOIN main_models.event_fielding_stats s USING (event_key)
    LEFT JOIN main_models.stg_event_flags f USING (event_key)
