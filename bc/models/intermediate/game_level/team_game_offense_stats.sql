MODEL (
  name main_models.team_game_offense_stats,
  kind FULL,
  ...
  columns (
    ...
    plate_appearances_while_on_base USMALLINT,
    balls_in_play_while_running USMALLINT,
    balls_in_play_while_on_base USMALLINT,
    batter_total_bases_while_running USMALLINT,
    batter_total_bases_while_on_base USMALLINT,
    ...
    times_lead_runner USMALLINT,
    times_force_on_runner USMALLINT,
    times_next_base_empty USMALLINT,
  ...
  physical_properties (
    download_parquet = 'https://data.baseball.computer/dbt/main_models_team_game_offense_stats.parquet'
  ),
);
