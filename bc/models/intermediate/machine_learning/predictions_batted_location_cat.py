"""SQLMesh wrapper around the Phase 6 batted-location multiclass scorer.
...
@model(
    "main_models.predictions_batted_location_cat",
    kind="FULL",
    enabled=artifact_exists("batted_location_cat"),
    columns={
        "event_key": "UINTEGER",
...
def execute(
    ...
    scorer = load_scorer("batted_location_cat")
