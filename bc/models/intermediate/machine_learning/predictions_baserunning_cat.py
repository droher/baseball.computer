"""SQLMesh wrapper around the Phase 6 baserunning multiclass scorer.
...
@model(
    "main_models.predictions_baserunning_cat",
    kind="FULL",
    enabled=artifact_exists("baserunning_cat"),
    columns={
        "event_key": "UINTEGER",
...
def execute(
    ...
    scorer = load_scorer("baserunning_cat")
