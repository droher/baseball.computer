"""SQLMesh wrapper around the Phase 6 is-win binary scorer.
...
@model(
    "main_models.predictions_is_win_bin",
    kind="FULL",
    enabled=artifact_exists("is_win_bin"),
    columns={
        "event_key": "UINTEGER",
